// 월간 달력 일정. start/end는 "YYYY-MM-DD"(end 포함). kind: beamtime(보라) | measurement(초록, 외부 기관 측정) | conference(주황) | travel(회색) | event (색만 다름)
...
window.SITE.schedule = {
  ...
  events: [
    // 2026-09-25 UK 지시: 10/1 하루, 충남대 Raman 측정
    { start: "2026-10-01", title: "Chungnam Univ. : Raman", kind: "measurement", note: "Chungnam National University · Raman measurement" },
    ...
    // 2026-09-25 UK 지시: 10/13 하루, 가천대 TEM 측정 (외부 기관 측정 = measurement, 초록)
    { start: "2026-10-13", title: "Gachon Univ. : TEM", kind: "measurement", note: "Gachon University · TEM measurement" },
